...
<template>
  <div class="min-h-[80vh] flex flex-col items-center justify-center px-4">
    <div class="text-center mb-8">
      <UIcon name="i-lucide-cat" class="size-16 text-primary mb-4" />
    ...
    <div class="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl w-full">
      <div class="text-center">
        <UIcon name="i-lucide-shield" class="size-8 text-primary mb-2" />
      ...
      <div class="text-center">
        <UIcon name="i-lucide-file-down" class="size-8 text-primary mb-2" />
        <h3 class="font-medium text-sm">
          Auto Backup
        </h3>
        <p class="text-xs text-muted mt-1">
      ...
      <div class="text-center">
        <UIcon name="i-lucide-sparkles" class="size-8 text-primary mb-2" />
        <h3 class="font-medium text-sm">
          Full Editor
        </h3>
        <p class="text-xs text-muted mt-1">
